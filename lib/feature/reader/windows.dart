...
class ReaderWin extends StatefulWidget {
  const ReaderWin({super.key, required this.title});

  final String title;

  @override
  State<ReaderWin> createState() => _ReaderStateWin();
}

class _ReaderStateWin extends State<ReaderWin> {
